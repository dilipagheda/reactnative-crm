        ...
        return (
            <View>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View>
                    <Button icon="arrow-left" mode="text" onPress={() => noneSelected()}>
                        Back
                    </Button>
                    </View>
                    <View>
                    ...
                    <View style={styles.personMetaInfoContainer}>
                        <Card>
                            ...
                            <Card.Actions style={styles.editDeleteButtonsContainer}>
                                ...
                                <Button onPress={this.onEditPress.bind(this)}>Edit</Button>
                            </Card.Actions>
                        </Card>
                    </View>
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                        ...
                        <View style={styles.actionButtonContainer}>
                            <Button icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
